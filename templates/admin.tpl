...
<div class="adminColumnist">
    ...
    <form action="admin/add/columnist/" method="post" class="addColumnist">
    ...
    <table>
        ...
        {foreach from=$podcasts item=podcast}
            <tr>
                ...
                <td class="editDelete"><a href="admin/edit/podcast/{$podcast->id_podcast}" >Editar</a></td>
                <td class="editDelete"><a href="admin/delete/podcast/{$podcast->id_podcast}">Eliminar</a></td>
            </tr>      
        {/foreach}
    </table>

    <form action="admin/add/podcast/" method="post" class="addPodcast">
